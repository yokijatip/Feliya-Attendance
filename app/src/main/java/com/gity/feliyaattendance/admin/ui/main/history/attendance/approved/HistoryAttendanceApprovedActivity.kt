package com.gity.feliyaattendance.admin.ui.main.history.attendance.approved
...
import com.gity.feliyaattendance.databinding.ActivityHistoryAttendanceApprovedBinding
...
class HistoryAttendanceApprovedActivity : AppCompatActivity() {

    private lateinit var binding: ActivityHistoryAttendanceApprovedBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityHistoryAttendanceApprovedBinding.inflate(layoutInflater)
    ...
    private fun setupEditDate(userId: String) {
        binding.moreMenu.setOnClickListener {
            ...
            val datePickerDialog = DatePickerDialog(
                this@HistoryAttendanceApprovedActivity,
    ...
    private fun fetchAttendanceByMonthAndYear(userId: String, year: Int, month: Int) {
        viewModel.fetchApprovedAttendanceByMonthAndYear(userId, year, month)
    }

    private fun observerData() {
        viewModel.historyAttendanceApproved.observe(this) { result ->
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvAttendanceApproved.layoutManager =
            LinearLayoutManager(this@HistoryAttendanceApprovedActivity)
    }
