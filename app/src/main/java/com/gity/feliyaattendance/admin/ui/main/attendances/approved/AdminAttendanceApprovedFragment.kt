 ...
 * Use the [AdminAttendanceApprovedFragment.newInstance] factory method to
...
class AdminAttendanceApprovedFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AdminAttendanceApprovedFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AdminAttendanceApprovedFragment().apply {
