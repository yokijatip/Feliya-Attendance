package com.gity.feliyaattendance.admin.ui.main.history.attendance.rejected
...
import com.gity.feliyaattendance.databinding.ActivityHistoryAttendanceRejectedBinding
...
class HistoryAttendanceRejectedActivity : AppCompatActivity() {

    private lateinit var binding: ActivityHistoryAttendanceRejectedBinding
    ...
    private fun setupEditDate() {
        binding.moreMenu.setOnClickListener {
            ...
            val datePickerDialog = DatePickerDialog(
                this@HistoryAttendanceRejectedActivity,
    ...
    private fun observerData() {
        viewModel.historyAttendanceRejected.observe(this) { result ->
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvAttendanceRejected.adapter = adapter
        binding.rvAttendanceRejected.layoutManager =
            LinearLayoutManager(this@HistoryAttendanceRejectedActivity)
    }
